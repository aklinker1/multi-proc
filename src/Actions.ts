...
export default class Actions {
  ...
  public static start = (CLI: CommanderStatic) => async (): Promise<void> => {
  ...
  public static readConfig = (configFile: string): NodeProcess[] => {
    ...
    return procs.map((proc) => new NodeProcess(proc, maxTagWidth));
  }
